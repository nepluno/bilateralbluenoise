...
void CDXUTDialog::InitDefaultElements()
{
    ...
    m_CapElement.TextureColor.States[ DXUT_STATE_NORMAL ] = D3DCOLOR_ARGB( 255, 0, 0, 0 );
    m_CapElement.FontColor.States[ DXUT_STATE_NORMAL ] = D3DCOLOR_ARGB( 255, 0, 0, 0 );
    m_CapElement.SetFont( 0, D3DCOLOR_ARGB( 255, 0, 0, 0 ), DT_LEFT | DT_VCENTER );
    ...
    Element.SetFont( 0, D3DCOLOR_ARGB( 255, 0, 0, 0 ) );
    Element.TextureColor.States[ DXUT_STATE_NORMAL ] = D3DCOLOR_ARGB( 150, 0, 0, 0 );
    Element.TextureColor.States[ DXUT_STATE_PRESSED ] = D3DCOLOR_ARGB( 200, 0, 0, 0 );
    ...
    Element.SetTexture( 0, &rcTexture, D3DCOLOR_ARGB( 0, 0, 0, 0 ) );
